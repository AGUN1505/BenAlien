...
class ListAlienAdapter(private val listAlien: ArrayList<Alien>) :
    ...
    override fun getItemCount(): Int = listAlien.size

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val (name, description, photo) = listAlien[position]
        ...
        holder.itemView.setOnClickListener {
            ...
            intentDetail.putExtra("key_alien", listAlien[holder.adapterPosition])
